...
import { IMaison, IContrat } from '../../shared/model/models';
...
export class MaisonService {
    ...
    getAllDeactivated(): Observable<IMaison[]> {
        tap(maisons => console.log("Maisons", maisons))
        catchError(this.handleError);
        return this.httpClient.get<IMaison[]>(this.API_URL + this.ENDPOINT_READ + '/deactivated');
    }
